  ...
  Future<String?> _uploadLogo() async {
    ...
    try {
      final storageRef = FirebaseStorage.instance
          .ref()
          .child('logonegocios/${nombreController.text}${DateTime.now().millisecondsSinceEpoch}.png');
          ...
          child: Column(
            ...
            builder: (context, negocioSnapshot) {
              ...
              final Set<dynamic> usuariosAsignados = negocios
                  .where((doc) => (doc.data() as Map<String, dynamic>).containsKey('encargado')) // Verificación del campo encargado
